...
local folder                        = Instance.new('Frame')
      ...
      folder.Size                   = UDim2.new(0, 142, 0, 208)
...
local trigger                        = Instance.new('TextButton')
      ...
      trigger.Transparency           = 0.949999988079071
      trigger.Text                   = ''
...
local integer                        = Instance.new('TextBox')
      ...
      integer.Transparency           = 0.8999999761581421
      integer.Text                   = ''
      integer.TextColor3             = Color3.new(1, 1, 1)
      integer.TextSize               = 14
